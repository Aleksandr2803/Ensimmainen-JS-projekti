...
onload = function(){
	...
	for(var i = 0; i < arr.length; i++){
		...
		/* täällä halusin käyttää addEveniä .. ja poistaa sen sitten, kun voittaja selvitettiin */
	}
	randomMove();
